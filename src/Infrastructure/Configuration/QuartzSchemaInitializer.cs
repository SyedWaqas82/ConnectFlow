...
public class QuartzSchemaInitializer
{
    ...
    public QuartzSchemaInitializer(string connectionString, string tablePrefix, ILogger<QuartzSchemaInitializer> logger)
    {
    ...
    private bool TablesExist()
    {
        ...
        command.Parameters.AddWithValue("@tableName", $"{_tablePrefix}JOB_DETAILS".ToLower());
    ...
    private void CreateQuartzTables()
    {
        ...
        if (_tablePrefix != "QRTZ_")
        {
            schemaScript = schemaScript.Replace("QRTZ_", _tablePrefix);
        }
