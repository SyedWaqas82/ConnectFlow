...
public class InvoiceConfiguration : BaseAuditableConfiguration<Invoice>
{
    public override void Configure(EntityTypeBuilder<Invoice> builder)
    {
        ...
        builder.Property(i => i.AmountDue).IsRequired().HasColumnType("decimal(18,2)");
        builder.Property(i => i.AmountPaid).IsRequired().HasColumnType("decimal(18,2)").HasDefaultValue(0);
