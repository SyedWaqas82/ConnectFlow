    ...
    public async Task Handle(UserCreatedEvent notification, CancellationToken cancellationToken)
    {
        ...
        var emailEvent = new EmailSendMessageEvent(notification.TenantId, notification.ApplicationUserId)
        {
            ...
            TemplateData = new Dictionary<string, object>
            {
                ...
                { "language", notification.Language ?? string.Empty },
                { "dateNumberFormat", notification.DateNumberFormat ?? string.Empty },
                { "defaultCurrency", notification.DefaultCurrency ?? string.Empty },
